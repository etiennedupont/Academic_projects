<?php
generate_menu_gauche_mesxpdeposees();
...
//    print_r($_POST);
$i=0;
foreach (experiences::get_xpdeposee($dbh,$_SESSION['id']) as $ligne) {
    ...
    generate_panel_searchdepose($mail,$tel,$idxp,$ligne,$temoin,$organisme,$i,$annee,$type,$like,$dbh);
    $i++;
}
